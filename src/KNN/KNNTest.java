...
public class KNNTest {
	public static void main(String[] args) {
		...
		//extractIntTest();
		//unsignedToSignedTest(); TODO
		//parsingTest();
		//squaredEuclideanDistanceTest();
		//moyenneDeuxImageTest(); TODO
	...
	public static void invertedSimilarityTest() {
		...
		byte[][] a = new byte[][] {{1, 20}, {5, 2}};
		byte[][] b = new byte[][] {{1, 20}, {5, 2}};
	...
	public static void encodeIntTest() {
		byte[] test = new byte[20];
		KMeansClustering.encodeInt(2049, test, 0);
